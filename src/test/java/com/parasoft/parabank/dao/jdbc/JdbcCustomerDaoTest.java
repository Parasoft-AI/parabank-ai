...
public class JdbcCustomerDaoTest extends AbstractParaBankDataSourceTest
{
     ...
     */
    @Test(timeout = 5000)
    public void testCreateCustomer_WithJdbcTemplateVariant() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
     ...
     */
    @Test(timeout = 5000)
    public void testCreateCustomer_WithAnotherJdbcTemplateVariant() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_BySSNWithoutMock() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_ByUsernameAndPasswordWithoutMock() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
